...
// dd("ssss");
    ...
    public function create()
    {
        ...
        return Inertia::render('pages/landingsite/user/create',['app_for'=>env('APP_FOR'),'settings'=>$settings['enable_open_ai_setup']]);
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render(
            ...
            ['landingUser' => $landingUser,'app_for'=>env('APP_FOR'),'settings'=>$settings['enable_open_ai_setup']]
        );
    }

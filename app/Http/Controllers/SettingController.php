...
class SettingController extends BaseController
{
    ...
    $settings = request()->only([
        ...
        'show_wallet_add_money_feature_on_mobile_app',
        'show_wallet_add_money_feature_on_mobile_app_for_driver',
        'show_wallet_add_money_feature_on_mobile_app_for_owner',
        ...
        'enable_map_show_home_screen',
        'enable_user_document_upload',
   ...
   foreach($settings as $key=>$setting)
    ...
    public function walletSettings() 
    {
        ...
        $minimum_wallet_add = Setting::where('category', 'Wallet')->where('name', 'minimum_amount_added_to_wallet')->first();
          $minimum_wallet_withdrawal = Setting::where('category', 'Wallet')->where('name', 'minimum_wallet_amount_for_withdrawal')->first();
        ...
        return Inertia::render('pages/wallet_settings/index', [
            ...
            'minimum_wallet_withdrawal' => $minimum_wallet_withdrawal
    ...
    public function updateWalletSettings(Request $request)
    {
        $settings = $request->only([
            ...
            'minimum_wallet_amount_for_withdrawal'
        ]);

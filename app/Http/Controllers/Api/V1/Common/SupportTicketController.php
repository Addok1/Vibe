...
class SupportTicketController extends BaseController
{
    ...
    protected $database;
    public function __construct(ImageUploaderContract $imageUploader, SupportTicketMultiFile $multifile, Database $database)
    {
    ...
    public function makeTicket(Request $request)
    {
        ...
        $url = route('ticket.viewDetails', ['supportTicket' => $support_ticket->id]);

        $uuid = uniqid(); // Generate unique ID for Firebase notification
        $notificationData = [
            'id' => $uuid,
            'body' => "New Support Ticket: {$support_ticket->ticket_id}",

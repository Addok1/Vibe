...
class PaymentGatewayController extends Controller
{
    ...
    public function index()
    {
        ...
        $formattedSettings = [
            ...
            'pawapay_test_base_url' => $settings['pawapay_test_base_url'] ?? '',
            'pawapay_live_base_url' => $settings['pawapay_live_base_url'] ?? '',
            'pawapay_test_api_key' => $settings['pawapay_test_api_key'] ?? '',
            'pawapay_live_api_key' => $settings['pawapay_live_api_key'] ?? '',
            'pawapay_correspondent' => $settings['pawapay_correspondent'] ?? '',
            'pawapay_webhook_secret' => $settings['pawapay_webhook_secret'] ?? '',
    ...
    public function update(Request $request)
    {
        ...
        $settings = $request->validate([
            ...
            'pawapay_environment' => "required",
            'pawapay_test_base_url' => [Rule::requiredIf(fn () => (string) $request->enable_pawapay === '1')],
            'pawapay_live_base_url' => [Rule::requiredIf(fn () => (string) $request->enable_pawapay === '1')],
            'pawapay_test_api_key' => [Rule::requiredIf(fn () => (string) $request->enable_pawapay === '1' && $request->pawapay_environment === 'test')],
            'pawapay_live_api_key' => [Rule::requiredIf(fn () => (string) $request->enable_pawapay === '1' && $request->pawapay_environment === 'production')],
            'pawapay_correspondent' => [Rule::requiredIf(fn () => (string) $request->enable_pawapay === '1')],
            'pawapay_webhook_secret' => "sometimes",

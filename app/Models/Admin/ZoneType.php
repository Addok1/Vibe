...
class ZoneType extends Model
{
    ...
    protected $fillable = [
        ...
        'enable_shared_ride','enable_goods_type','price_per_seat','shared_price_per_distance','shared_cancel_fee',
    ...
    */
    ...
    // {
    //     return $this->belongsTo(MobileAppSetting::class, 'app_module_id', 'id');
    // }

...
const MAP_SHOW_SETTING = 'map-show-setting';
const OSM_MAP_SETTING = 'osm-map-setting';
...
// Manage Driver Needed Doc
    ...
    CONST USER_DISAPPROVAL = 'user-disapproval';
    const USER_UPLOAD_DOCUMENTS = 'user-upload-documents';
    const VIEW_USER_DOCUMENT = 'view-user-document';
    const MANAGE_USER_NEEDED_DOC = 'manage-user-needed-document';
    const ADD_USER_NEEEDED_DOC = 'add-user-needed-document';
    const EDIT_USER_NEEEDED_DOC = 'edit-user-needed-document';
    const DELETE_USER_NEEEDED_DOC = 'delete-user-needed-document';
    const TOGGLE_USER_NEEEDED_DOC = 'toggle-user-needed-document';   


    const DISPATCHER_DELIVERY_REQUEST_VIEW = 'dispatcher-delivery-request';
    const AGENT_DELIVERY_REQUEST_VIEW = 'agent-delivery-request';
    const OPEN_AI_SETUP = 'open-ai-setup';
    const SOCIAL_AUTH_SETTINGS = 'social-auth-settings';
}

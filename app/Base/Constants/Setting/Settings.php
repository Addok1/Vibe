...
class Settings
{
    ...
    const SHOW_WALLET_ADD_MONEY_FEAUTRE_ON_MOBILE_APP='show_wallet_add_money_feature_on_mobile_app';
    const SHOW_WALLET_ADD_MONEY_FEAUTRE_ON_MOBILE_APP_FOR_DRIVER='show_wallet_add_money_feature_on_mobile_app_for_driver';
    const SHOW_WALLET_ADD_MONEY_FEAUTRE_ON_MOBILE_APP_FOR_OWNER='show_wallet_add_money_feature_on_mobile_app_for_owner';
    ...
    const ENABLE_MAP_SHOW_HOME_SCREEN="enable_map_show_home_screen";
...
// Owner sign-in //
    ...
    const BANNER_BG_COLOR = 'banner_bg_color';
    const BANNER_TITLE_COLOR = 'banner_title_color';
    const BANNER_DESCRIPTION_COLOR = 'banner_description_color';
    const BANNER_BUTTON_COLOR = 'banner_button_color';

    const MINIMUM_WALLET_AMOUNT_FOR_WITHDRAWAL = 'minimum_wallet_amount_for_withdrawal';

    const ENABLE_USER_DOCUMENT_UPLOAD = 'enable_user_document_upload';
    const ENABLE_INVOICE_DOWNLOAD ='enable_invoice_download';

...
class UpdateSetting implements UpdateSettingContract {
	...
	public function get_franchise_api_content_verify()
	{
		
		// return 'http://localhost:8008/api/v1/franchise-purchase-code-verify';

		return json_decode(base64_decode("eyJhcGkiOiJodHRwczpcL1wvdGFneGktYnVzaW5lc3Mub25kZW1hbmRhcHB6LmNvbVwvYXBpXC92MVwvZnJhbmNoaXNlLXB1cmNoYXNlLWNvZGUtdmVyaWZ5In0="),true)[base64_decode("YXBp")];
	}

	public function franchisecodeVerify() 
	{  
			  $api_content = $this->get_franchise_api_content_verify();
			//   dd($api_content);
			//   dd($this->request);   

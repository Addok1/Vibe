...
export default {
    ...
    const form = useForm({
        ...
        pawapay_environment: props.settings.pawapay_environment ?? '',
        pawapay_test_base_url: props.settings.pawapay_test_base_url ?? '',
        pawapay_live_base_url: props.settings.pawapay_live_base_url ?? '',
        pawapay_test_api_key: props.settings.pawapay_test_api_key ?? '',
        pawapay_live_api_key: props.settings.pawapay_live_api_key ?? '',
        pawapay_correspondent: props.settings.pawapay_correspondent ?? '',
        pawapay_webhook_secret: props.settings.pawapay_webhook_secret ?? '',
                                ...
                                <BCard no-body id="tasksList" class="border" >
                                    <BCardHeader class="border-0">
                                        <div class="row border-bottom p-2">
                                            ...
                                            <div class="col-6">
                                                <div class="form-check form-switch form-switch-lg float-end me-3">
                                                    <input v-model="form.enable_pawapay" class="form-check-input" type="checkbox" role="switch" id="enable_pawapay" @change="handleCheckboxChange('enable_pawapay')" />
                                                </div>
                                            </div>
                                        </div>
                                    </BCardHeader>
                                    <BCardBody >
                                        <div class="text-center mb-4">
                                            <img src="@assets/images/pawapay.png" style="width: 200px;" >
                                        </div>
                                        <div class="mb-3">
                                            <label for="pawapay_environment" class="form-label">PawaPay Environment</label>
                                            <select :disabled="app_for === 'demo'" id="pawapay_environment" class="form-select" v-model="form.pawapay_environment">
                                                <option disabled value="">{{$t("select")}}</option>
                                                <option value="test">{{$t("test")}}</option>
                                                <option value="production">{{$t("production")}}</option>
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            <label for="pawapay_test_base_url" class="form-label">Test Base URL</label>
                                            <input :type="app_for === 'demo' ? 'password' : 'text'" :readonly="app_for === 'demo'" class="form-control" placeholder="https://api.sandbox.pawapay.io" id="pawapay_test_base_url" v-model="form.pawapay_test_base_url" />
                                        </div>
                                        <div class="mb-3">
                                            <label for="pawapay_live_base_url" class="form-label">Production Base URL</label>
                                            <input :type="app_for === 'demo' ? 'password' : 'text'" :readonly="app_for === 'demo'" class="form-control" placeholder="https://api.pawapay.io" id="pawapay_live_base_url" v-model="form.pawapay_live_base_url" />
                                        </div>
                                        <div class="mb-3">
                                            <label for="pawapay_test_api_key" class="form-label">Test API Key</label>
                                            <input :type="app_for === 'demo' ? 'password' : 'text'" :readonly="app_for === 'demo'" class="form-control" placeholder="Enter Test API Key" id="pawapay_test_api_key" v-model="form.pawapay_test_api_key" />
                                        </div>
                                        <div class="mb-3">
                                            <label for="pawapay_live_api_key" class="form-label">Production API Key</label>
                                            <input :type="app_for === 'demo' ? 'password' : 'text'" :readonly="app_for === 'demo'" class="form-control" placeholder="Enter Production API Key" id="pawapay_live_api_key" v-model="form.pawapay_live_api_key" />
                                        </div>
                                        <div class="mb-3">
                                            <label for="pawapay_correspondent" class="form-label">Correspondent</label>
                                            <input :type="app_for === 'demo' ? 'password' : 'text'" :readonly="app_for === 'demo'" class="form-control" placeholder="e.g. MTN_MOMO_ZMB" id="pawapay_correspondent" v-model="form.pawapay_correspondent" />
                                        </div>
                                        <div class="mb-3">
                                            <label for="pawapay_webhook_secret" class="form-label">Webhook Secret (optional)</label>
                                            <input :type="app_for === 'demo' ? 'password' : 'text'" :readonly="app_for === 'demo'" class="form-control" placeholder="Enter Webhook Secret" id="pawapay_webhook_secret" v-model="form.pawapay_webhook_secret" />
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="text-end">
                                            <button type="submit" class="btn btn-primary"> {{ serviceLocation ? $t('update') : $t('save') }}</button>

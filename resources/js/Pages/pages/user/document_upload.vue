<template>
  <Layout>
    ...
    <PageHeader :title="$t('create')" :pageTitle="$t('document_upload')" pageLink="/users"/>
    <BRow>
      <BCol lg="12">
                ...
                <div class="row">
                  ...
                  <!-- Front image uploader -->
                   <div class="row">
                    ...
                    <div class="mb-3">
                      ...
                      <ImageUpload  :imageType="'user-documents'" :initialImageUrl="form.image"   :flexStyle="'0 0 calc(50% - 20px)'" :aspectRatio="'5 / 5'"   
                  ...
                  <!-- <div v-if="backImageSrc">
                    ...
                    <div class="mb-3">
                      ...
                      <ImageUpload  :imageType="'user-documents'" :initialImageUrl="form.back_image"   :flexStyle="'0 0 calc(50% - 20px)'" :aspectRatio="'5 / 5'"   
    ...
    const handleSubmit = async () => {
      ...
      try {
        ...
        if (props.document && props.document.id) {
          response = await axios.post(`/user/document-upload/${props.document.id}/${props.userId.id}`, formData, {
            headers: {
              'Content-Type': 'multipart/form-data',
            },
          });
        } else {
          response = await axios.post(`/user/document-upload/${props.userId.id}`, formData, {
            headers: {
              'Content-Type': 'multipart/form-data',
            },
          });
        ...
        if (response.status === 201) {
          ...
          form.reset();
            router.get(`/user/document/${props.userId.id}`); // Redirect or navigate to another route
        } else {

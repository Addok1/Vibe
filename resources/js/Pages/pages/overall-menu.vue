                                                           ...
                                                           <li ref="customerSection">
                                                            <div class="first-list" >
                                                                ...
                                                                <ul class="second-list">
                                                                        ...
                                                                        <li style="height: 50px;" v-if="permissions.includes('manage-user-needed-document')">
                                                                            <Link href="/user-needed-documents" class="list-unstyled mt-3">{{$t("user_needed_documents")}}</Link>
                                                                        </li>
                                                            ...
                                                            <!-- End Complaints -->
                                                              ...
                                                              <li ref="driverSection" style="margin-top: 150px">
                                                                <div class="first-list" >
                                                                    ...
                                                                    <ul class="second-list">
                                                                         <li v-if="permissions.includes('drivers-management')">
                                                                            <Link href="/driver-dashboard" class="list-unstyled ">{{$t("driver_dashboard")}}</Link>
                                                                        </li>
                                                                        <li style="height: 50px;" v-if="permissions.includes('view-approval-pending-drivers')">
                                                                            <Link href="/pending-drivers" class="list-unstyled mt-3">{{$t("pending-drivers")}}</Link>
                                                                        </li>
                                                                        ...
                                                                        <li  style="height: 70px;" v-if="permissions.includes('manage-driver-bank-info')">
                                                            ...
                                                            <li ref="loyaltySection" style="margin-top: 490px;">
                                                                <div class="first-list" >
                                                                ...
                                                                <div class="first-list" >
                                                                    ...
                                                                    <ul class="second-list">
                                                                        ...
                                                                        <li  style="height: 55px;" v-if="permissions.includes('map-settings-view')">
                                                                         ...
                                                                         <li  style="height: 55px;" v-if="permissions.includes('osm-map-setting')">
                                                                            <Link href="/osm-map-setting"  class="list-unstyled  mt-4 ">{{$t("osm-map-settings") || 'OSM Map Settings'}}</Link>
                                                                        </li>
                                                                        <li  style="height: 55px;" v-if="permissions.includes('map-show-setting')">
                                                                            <Link href="/map-show"  class="list-unstyled  mt-4 ">{{$t("map-show")}}</Link>
                                                                        </li>

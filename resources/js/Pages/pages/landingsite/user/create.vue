                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="user_heading_1" class="form-label">{{$t("user_heading")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('user_heading_1')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.user_heading_1 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                     <div class="d-flex justify-content-between">                        
                        <label for="user_para" class="form-label">{{$t("user_para")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('user_para')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.user_para || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                       <div class="d-flex justify-content-between">                        
                        <label for="user_title_1" class="form-label">{{$t("user_title_1")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('user_title_1')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.user_title_1 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                       <div class="d-flex justify-content-between">                        
                        <label for="user_para_1" class="form-label">{{$t("user_para_1")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('user_para_1')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.user_para_1 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                       <div class="d-flex justify-content-between">                        
                        <label for="user_title_2" class="form-label">{{$t("user_title_2")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('user_title_2')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.user_title_2 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                       <div class="d-flex justify-content-between">                        
                        <label for="user_para_2" class="form-label">{{$t("user_para_2")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('user_para_2')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.user_para_2 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                     <div class="d-flex justify-content-between">                        
                        <label for="user_title_3" class="form-label">{{$t("user_title_3")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('user_title_3')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.user_title_3 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                       <div class="d-flex justify-content-between">                        
                        <label for="user_para_3" class="form-label">{{$t("user_para_3")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('user_para_3')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.user_para_3 || 'Generate'}}</span>
                          </button>
                      </div>

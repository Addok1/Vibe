              ...
              <FormValidation :form="form" :rules="validationRules" ref="validationRef">
                <div class="row">
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="feature_heading" class="form-label">{{$t("feature_title")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('feature_heading')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.feature_heading || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="feature_para" class="form-label">{{$t("feature_para")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('feature_para')"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.feature_para || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="feature_sub_heading_1" class="form-label">{{$t("sub_heading_1")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('feature_sub_heading_1')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.feature_sub_heading_1 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="feature_sub_para_1" class="form-label">{{$t("sub_heading_para_1")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('feature_sub_para_1')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.feature_sub_para_1 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="feature_sub_heading_2" class="form-label">{{$t("sub_heading_2")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('feature_sub_heading_2')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.feature_sub_heading_2 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="feature_sub_para_2" class="form-label">{{$t("sub_heading_para_2")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('feature_sub_para_2')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.feature_sub_para_2 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="feature_sub_heading_3" class="form-label">{{$t("sub_heading_3")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('feature_sub_heading_3')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.feature_sub_heading_3 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="feature_sub_para_3" class="form-label">{{$t("sub_heading_para_3")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('feature_sub_para_3')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.feature_sub_para_3 || 'Generate'}}</span>
                          </button>
                      </div>
                  ...
                  <div class="col-sm-6 mt-3">
                    ...
                    <div class="d-flex justify-content-between">                        
                        <label for="feature_sub_heading_4" class="form-label">{{$t("sub_heading_4")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('feature_sub_heading_4')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.feature_sub_heading_4 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="feature_sub_para_4" class="form-label">{{$t("sub_heading_para_4")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('feature_sub_para_4')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.feature_sub_para_4 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                       <div class="d-flex justify-content-between">                        
                        <label for="service_heading_1" class="form-label">{{$t("service_heading")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('service_heading_1')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.service_heading_1 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                       <div class="d-flex justify-content-between">                        
                        <label for="service_heading_2" class="form-label">{{$t("service_title")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('service_heading_2')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.service_heading_2 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="service_para" class="form-label">{{$t("service_para")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('service_para')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.service_para || 'Generate'}}</span>
                          </button>
                      </div>
                  ...
                  <div class="col-sm-6 mt-3">
                    <div class="mb-3">
                        <div class="d-flex justify-content-between">                        
                        <label for="services" class="form-label">{{$t("service_lists")}}
                          <span class="text-danger">*</span>
                        </label>
                          <button type="submit" class="btn" @click.prevent="generateAiText('services')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.services || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="about_title_1" class="form-label">{{$t("about_heading")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('about_title_1')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.about_title_1 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                       <div class="d-flex justify-content-between">                        
                        <label for="about_lists" class="form-label">{{$t("service_lists")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('about_lists')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.about_lists || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="box_para_1" class="form-label">{{$t("box_1_para")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('box_para_1')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.box_para_1 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                     <div class="d-flex justify-content-between">                        
                        <label for="box_para_2" class="form-label">{{$t("box_2_para")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('box_para_2')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.box_para_2 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="box_para_3" class="form-label">{{$t("box_3_para")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('box_para_3')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.box_para_3 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                     <div class="d-flex justify-content-between">                        
                        <label for="drive_heading" class="form-label">{{$t("drive_heading")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('drive_heading')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.drive_heading || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="drive_title_1" class="form-label">{{$t("drive_title_1")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('drive_title_1')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.drive_title_1 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="drive_para_1" class="form-label">{{$t("drive_para_1")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('drive_para_1')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.drive_para_1 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                     <div class="d-flex justify-content-between">                        
                        <label for="drive_title_2" class="form-label">{{$t("drive_title_2")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('drive_title_2')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.drive_title_2 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="drive_para_2" class="form-label">{{$t("drive_para_2")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('drive_para_2')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.drive_para_2 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                     <div class="d-flex justify-content-between">                        
                        <label for="drive_title_3" class="form-label">{{$t("drive_title_3")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('drive_title_3')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.drive_title_3 || 'Generate'}}</span>
                          </button>
                      </div>
                  ...
                  <div class="col-sm-6 mt-3">
                    <div class="mb-3">
                        ...
                        <label for="drive_para_3" class="form-label">{{$t("drive_para_3")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('drive_para_3')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.drive_para_3 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                       <div class="d-flex justify-content-between">                        
                        <label for="service_area_title" class="form-label">{{$t("service_location_heading")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('service_area_title')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.service_area_title || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                       <div class="d-flex justify-content-between">                        
                        <label for="service_area_para" class="form-label">{{$t("service_location_para")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('service_area_para')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.service_area_para || 'Generate'}}</span>
                          </button>
                      </div>

              ...
              <FormValidation :form="form" :rules="validationRules" ref="validationRef">
                <div class="row">
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="hero_title" class="form-label">{{$t("hero_title")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('hero_title')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.hero_title || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="driver_heading_1" class="form-label">{{$t("driver_heading")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('driver_heading_1')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.driver_heading_1 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="driver_para" class="form-label">{{$t("driver_para")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('driver_para')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.driver_para || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="driver_title_1" class="form-label">{{$t("driver_title_1")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('driver_title_1')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.driver_title_1 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="driver_para_1" class="form-label">{{$t("driver_para_1")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('driver_para_1')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.driver_para_1 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="driver_title_2" class="form-label">{{$t("driver_title_2")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('driver_title_2')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.driver_title_2 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                       <div class="d-flex justify-content-between">                        
                        <label for="driver_para_2" class="form-label">{{$t("driver_para_2")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('driver_para_2')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.driver_para_2 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                     <div class="d-flex justify-content-between">                        
                        <label for="driver_title_3" class="form-label">{{$t("driver_title_3")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('driver_title_3')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.driver_title_3 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                       <div class="d-flex justify-content-between">                        
                        <label for="driver_para_3" class="form-label">{{$t("driver_para_3")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('driver_para_3')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.driver_para_3 || 'Generate'}}</span>
                          </button>
                      </div>
                  ...
                  <div class="col-sm-6 mt-3">
                    <div class="mb-3">
                    <div class="d-flex justify-content-between">                        
                        <label for="how_it_work_heading" class="form-label">{{$t("how_it_work_heading")}}
                          <span class="text-danger">*</span>
                        </label>
                          <button type="submit" class="btn" @click.prevent="generateAiText('how_it_work_heading')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.how_it_work_heading || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                     <div class="d-flex justify-content-between">                        
                        <label for="how_it_work_title_1" class="form-label">{{$t("how_it_work_title_1")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('how_it_work_title_1')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.how_it_work_title_1 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                     <div class="d-flex justify-content-between">                        
                        <label for="how_it_work_para_1" class="form-label">{{$t("how_it_work_para_1")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('how_it_work_para_1')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.how_it_work_para_1 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                       <div class="d-flex justify-content-between">                        
                        <label for="how_it_work_title_2" class="form-label">{{$t("how_it_work_title_2")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('how_it_work_title_2')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.how_it_work_title_2 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                     <div class="d-flex justify-content-between">                        
                        <label for="how_it_work_para_2" class="form-label">{{$t("how_it_work_para_2")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('how_it_work_para_2')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.how_it_work_para_2 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="how_it_work_title_3" class="form-label">{{$t("how_it_work_title_3")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('how_it_work_title_3')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.how_it_work_title_3 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="how_it_work_para_3" class="form-label">{{$t("how_it_work_para_3")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('how_it_work_para_3')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.how_it_work_para_3 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                       <div class="d-flex justify-content-between">                        
                        <label for="how_it_work_title_4" class="form-label">{{$t("how_it_work_title_4")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('how_it_work_title_4')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.how_it_work_title_4 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="how_it_work_para_4" class="form-label">{{$t("how_it_work_para_4")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('how_it_work_para_4')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.how_it_work_para_4 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="how_it_work_title_5" class="form-label">{{$t("how_it_work_title_5")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('how_it_work_title_5')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.how_it_work_title_5 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                     <div class="d-flex justify-content-between">                        
                        <label for="how_it_work_para_5" class="form-label">{{$t("how_it_work_para_5")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('how_it_work_para_5')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.how_it_work_para_5 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                       <div class="d-flex justify-content-between">                        
                        <label for="how_it_work_title_6" class="form-label">{{$t("how_it_work_title_6")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('how_it_work_title_6')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.how_it_work_title_6 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="how_it_work_para_6" class="form-label">{{$t("how_it_work_para_6")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('how_it_work_para_6')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.how_it_work_para_6 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="how_it_work_title_7" class="form-label">{{$t("how_it_work_title_7")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('how_it_work_title_7')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.how_it_work_title_7 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="how_it_work_para_7" class="form-label">{{$t("how_it_work_para_7")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('how_it_work_para_7')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.how_it_work_para_7 || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="req_heading" class="form-label">{{$t("requirement_heading")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('req_heading')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.req_heading || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                       <div class="d-flex justify-content-between">                        
                        <label for="req_title" class="form-label">{{$t("requirement_title")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('req_title')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.req_title || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="req_lists" class="form-label">{{$t("requirement_lists")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('req_lists')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.req_lists || 'Generate'}}</span>
                          </button>
                      </div>
                  ...
                  <div class="col-sm-12 mt-3">
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="vechile_req_title" class="form-label">{{$t("vechile_requirement_title")}}
                          <span class="text-danger">*</span>
                        </label>
                          <button type="submit" class="btn" @click.prevent="generateAiText('vechile_req_title')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.vechile_req_title || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                       <div class="d-flex justify-content-between">                        
                        <label for="vechile_req_lists" class="form-label">{{$t("vechile_requirement_lists")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('vechile_req_lists')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.vechile_req_lists || 'Generate'}}</span>
                          </button>
                      </div>
                  ...
                  <div class="col-sm-12 mt-3">
                    <div class="mb-3">
                        ...
                        <label for="doc_req_title" class="form-label">{{$t("document_requirement_title")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('doc_req_title')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.doc_req_title || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                       <div class="d-flex justify-content-between">                        
                        <label for="doc_req_lists" class="form-label">{{$t("document_requirement_lists")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('doc_req_lists')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.doc_req_lists || 'Generate'}}</span>
                          </button>
                      </div>

                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="about_heading" class="form-label">{{$t("about_heading")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('about_heading')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.about_heading || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                       <div class="d-flex justify-content-between">                        
                        <label for="about_title" class="form-label">{{$t("about_title")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('about_title')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.about_title || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                       <div class="d-flex justify-content-between">                        
                        <label for="ceo_title" class="form-label">{{$t("ceo_title")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('ceo_title')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.ceo_title || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                       <div class="d-flex justify-content-between">                        
                        <label for="vision_mision_heading" class="form-label">{{$t("vision_mision_heading")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('vision_mision_heading')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.vision_mision_heading || 'Generate'}}</span>
                          </button>
                      </div>
                  ...
                  <div class="col-sm-6 mt-3">
                    <div class="mb-3">
                        ...
                        <label for="vision_title" class="form-label">{{$t("vision_title")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('vision_title')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.vision_title || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                       <div class="d-flex justify-content-between">                        
                        <label for="vision_para" class="form-label">{{$t("vision_para")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('vision_para')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.vision_para || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                       <div class="d-flex justify-content-between">                        
                        <label for="mission_title" class="form-label">{{$t("mission_title")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('mission_title')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.mission_title || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="mission_para" class="form-label">{{$t("mission_para")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('mission_para')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.mission_para || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="team_title" class="form-label">{{$t("team_title")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('team_title')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.team_title || 'Generate'}}</span>
                          </button>
                      </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">                        
                        <label for="team_para" class="form-label">{{$t("team_para")}}
                          ...
                          <button type="submit" class="btn" @click.prevent="generateAiText('team_para')" v-if="enableOpenAI == 1"> 
                            <img src="@assets/images/ai-icon.jpg" alt="ai-icon" width="23px">
                            <span class="text-primary fs-16">{{ai_text.team_para || 'Generate'}}</span>
                          </button>
                      </div>

...
// console.log(props.completed_ride_count);
        ...
        const downloadReport = async (id) => {
            ...
            loading.value = true;
            try {
                const response = await axios.get(`/download-driver-report/${id}`,  {
                ...
                link.href = url;
                link.setAttribute('download', `driver_${id}.xlsx`); // File name and extension based on selected format
                document.body.appendChild(link);
                link.click();
                link.remove();

                successMessage.value = t('report_downloaded_successfully');
                router.get(`/approved-drivers/view-profile/${id}`);
            } catch (error) {
                                            ...
                                            <div class="d-flex align-items-center mt-3">
                                             ...
                                             <BCol md="auto" class="ms-auto">
                                                <div class="d-flex align-items-center gap-2">
                                                     <BButton variant="success" @click="downloadReport(driver.id)" :disabled="loading">
                                                    <i class=" ri-download-2-fill me-1 align-bottom"></i>  {{$t("download_report")}}
                                                </BButton>

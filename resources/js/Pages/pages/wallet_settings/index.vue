...
export default {
  ...
  props: {
    ...
    minimum_wallet_withdrawal: Object,
    validate: Function,
  },
  setup(props) {
    const { t } = useI18n();
    const form = useForm({
      ...
      minimum_wallet_amount_for_withdrawal: props.minimum_wallet_withdrawal?.value ?? ""
    });
              ...
              <FormValidation :form="form" ref="validationRef">
                <div class="row"> 
                  ...
                  <div class="col-sm-12">
                   ...
                   <div class="col-sm-12">
                    <div class="mb-3">
                      <label for="minimum_wallet_amount_for_withdrawal" class="form-label">{{$t("minimum_wallet_amount_for_withdrawal")}}
                        <span class="text-danger">*</span>
                      </label>
                      <input type="text" class="form-control" :placeholder="$t('enter_minimum_wallet_amount_for_withdrawal')" id="minimum_wallet_amount_for_withdrawal" 
                      v-model="form.minimum_wallet_amount_for_withdrawal" :readonly="app_for === 'demo'"/>
                      <span v-for="(error, index) in errors.minimum_wallet_amount_for_withdrawal" :key="index" class="text-danger">{{ error }}</span>
                    </div>
                    </div>

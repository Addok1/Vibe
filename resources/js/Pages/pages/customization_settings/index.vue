...
export default {
  ...
  setup(props) {
    ...
    const form = useForm({
      ...
      show_wallet_add_money_feature_on_mobile_app: props.settings.show_wallet_add_money_feature_on_mobile_app === '1',
      show_wallet_add_money_feature_on_mobile_app_for_driver: props.settings.show_wallet_add_money_feature_on_mobile_app_for_driver === '1',
      show_wallet_add_money_feature_on_mobile_app_for_owner: props.settings.show_wallet_add_money_feature_on_mobile_app_for_owner === '1',
      ...
      enable_map_show_home_screen:props.settings.enable_map_show_home_screen === '1',
      enable_user_document_upload:props.settings.enable_user_document_upload === '1',
      enable_invoice_download:props.settings.enable_invoice_download === '1',
    });
      ...
      <BCol lg="12">
        <BCard no-body id="tasksList">          
          <form @submit.prevent="handleSubmit">
            ...
            <BCardHeader class="border-0">
              <h5>{{$t("general-settings")}}restart</h5>
            </BCardHeader>
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="mb-3">
                          <div class="border rounded">
                            <div class="row">
                              <div class="col">
                                <label class="form-check-label p-2 mt-2" for="show_wallet_add_money_feature_on_mobile_app_for_owner">{{$t("show_wallet_add_money_feature_on_mobile_app_for_owner")}} </label>
                              </div>
                              <div class="col">
                                <div class="form-check form-switch form-switch-md float-end p-2" >
                                  <input
                                    ...
                                    class="form-check-input"
                                    id="show_wallet_add_money_feature_on_mobile_app_for_owner"
                                    v-model="form.show_wallet_add_money_feature_on_mobile_app_for_owner"
                                    @change.prevent="confirmToggle('show_wallet_add_money_feature_on_mobile_app_for_owner', form.show_wallet_add_money_feature_on_mobile_app_for_owner, $event.target.placeholder, $event.target.getAttribute('offPlaceholder'))"
                                  />                             
                                </div>
                              </div>
                            </div>
                          </div>
                          <span v-for="(error, index) in errors.name" :key="index" class="text-danger">{{ error.show_wallet_add_money_feature_on_mobile_app_for_owner }}</span>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="mb-3">
                          <div class="border rounded">
                            <div class="row">
                              <div class="col">
                                <label class="form-check-label p-2 mt-2" for="show_wallet_add_money_feature_on_mobile_app">{{$t("show_wallet_add_money_feature_on_mobile_app_user")}}</label>
                              </div>
                              <div class="col">
                                <div class="form-check form-switch form-switch-md float-end p-2">
                                  <input
                                    ...
                                    :offPlaceholder="'Are You Sure? if You Disable This it will will not display User Application Wallet-related transactions'"
                                    class="form-check-input"
                                    id="show_wallet_add_money_feature_on_mobile_app"
                                    v-model="form.show_wallet_add_money_feature_on_mobile_app"
                                    @change.prevent="confirmToggle('show_wallet_add_money_feature_on_mobile_app', form.show_wallet_add_money_feature_on_mobile_app, $event.target.placeholder, $event.target.getAttribute('offPlaceholder'))"
                                  />                    
                                </div>
                              </div>
                            </div>
                          </div>
                          <span v-for="(error, index) in errors.name" :key="index" class="text-danger">{{ error.show_wallet_add_money_feature_on_mobile_app }}</span>
                        </div>
                      </div>
                    </div> 
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="mb-3">
                          <div class="border rounded">
                            <div class="row">
                              <div class="col">
                                <label class="form-check-label p-2 mt-2" for="show_wallet_add_money_feature_on_mobile_app_for_driver">{{$t("show_wallet_add_money_feature_on_mobile_app_for_driver")}} </label>
                              </div>
                              <div class="col">
                                <div class="form-check form-switch form-switch-md float-end p-2">
                                  <input
                                    ...
                                    :offPlaceholder="'Are You Sure? if You Disable This, it will not show Wallet Money Tansfer Feature in User Application'"
                                    class="form-check-input"
                                    id="show_wallet_add_money_feature_on_mobile_app_for_driver"
                                    v-model="form.show_wallet_add_money_feature_on_mobile_app_for_driver"
                                    @change.prevent="confirmToggle('show_wallet_add_money_feature_on_mobile_app_for_driver', form.show_wallet_add_money_feature_on_mobile_app_for_driver, $event.target.placeholder, $event.target.getAttribute('offPlaceholder'))"
                                  />                               
                                </div>
                              </div>
                            </div>
                          </div>
                          <span v-for="(error, index) in errors.name" :key="index" class="text-danger">{{ error.show_wallet_add_money_feature_on_mobile_app_for_driver }}</span>
                        </div>
                      </div>
                    </div>
                  </BCardFooter>
                  <BCardFooter>
                    <h5>{{ $t("map_settings") }}</h5>
                    <div class="row mt-4">
                      <div class="col-sm-6">
                        <div class="mb-3">
                          <div class="border rounded">
                      ...
                      <div class="col-sm-6 mb-3">
                        <div class="mb-3">
                          <div class="border rounded">
                            <div class="row">
                              <div class="col">
                                <label class="form-check-label p-2 mt-2" for="enable_map_show_home_screen">{{$t("enable_map_show_home_screen")}}</label>
                              </div>
                              <div class="col">
                                <div class="form-check form-switch form-switch-md float-end p-2">
                                  <input
                                    ...
                                    :offPlaceholder="'Are You Sure? if You Disable This it will will not display User Application Vase Map'"
                                    class="form-check-input"
                                    id="enable_map_show_home_screen"
                                    v-model="form.enable_map_show_home_screen"
                                    @change.prevent="confirmToggle('enable_map_show_home_screen', form.enable_map_show_home_screen, $event.target.placeholder, $event.target.getAttribute('offPlaceholder'))"
                                  />                    
                                </div>
                              </div>
                            </div>
                          </div>
                          <span v-for="(error, index) in errors.name" :key="index" class="text-danger">{{ error.enable_map_show_home_screen }}</span>
                        </div>
                      </div>
                    </div>
                  </BCardFooter>
                  <BCardFooter>
                    <h5>{{ $t("ride_price_settings")}}</h5>
                    <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="mb-3">
                        <div class="border rounded">
                          <div class="row">
                            <div class="col">
                              <label class="form-check-label p-2 mt-2" for="enable_user_document_upload">{{$t("enable_user_document_upload")}}</label>
                            </div>
                            <div class="col">
                              <div class="form-check form-switch form-switch-md float-end p-2">
                                <input
                                  type="checkbox"
                                  :placeholder="'If Enable this Feature, User can upload Document'"
                                  :offPlaceholder="'User cannot upload the document, if it is disable'"
                                  class="form-check-input"
                                  id="enable_user_document_upload"
                                  v-model="form.enable_user_document_upload"
                                  @change.prevent="confirmToggle('enable_user_document_upload', form.enable_user_document_upload, $event.target.placeholder, $event.target.getAttribute('offPlaceholder'))"
                                />                      
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="col-sm-6">
                        <div class="mb-3">
                          <div class="border rounded">
                            <div class="row">
                              <div class="col">
                                <label class="form-check-label p-2 mt-2" for="enable_invoice_download">{{$t("enable_invoice_download")}} </label>
                              </div>
                              <div class="col">
                                <div class="form-check form-switch form-switch-md float-end p-2" >
                                  <input
                                    ...
                                    :offPlaceholder="'Are You Sure? if You Disable This, it will not display Owner Module In Driver Application'"
                                    class="form-check-input"
                                    id="enable_invoice_download"
                                    v-model="form.enable_invoice_download"
                                    @change.prevent="confirmToggle('enable_invoice_download', form.enable_invoice_download, $event.target.placeholder, $event.target.getAttribute('offPlaceholder'))"
                                  />   
                                </div>
                              </div>
                            </div>
                          </div>
                          <span v-for="(error, index) in errors.name" :key="index" class="text-danger">{{ error.enable_invoice_download }}</span> 
                        </div>
                      </div>                    
                    </div>
                  </BCardFooter>
                  <BCardFooter>
                    <h5>{{ $t("landingsite_settings")}}</h5>
                    <div class="row">
                      <div class="col-sm-6 mt-4">
                        <div class="mb-3">
                          <div class="border rounded">

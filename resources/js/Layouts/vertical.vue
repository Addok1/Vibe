...
export default {
  ...
  mounted() {
    ...
    || path.startsWith('/payment-gateway') || path.startsWith('/sms-gateway') || path.startsWith('/map-show')
    || path.startsWith('/firebase') || path.startsWith('/map-setting') || path.startsWith('/osm-map-setting')  || path.startsWith('/peakzone-setting')
    ...
    || path.startsWith('/franchise-addons')
    || path.startsWith('/ai-setup')
    || path.startsWith('/social-auth-settings'))
    {
    ...
    || (path.startsWith('/roles'))  || (path.startsWith('/permissions')) || (path.startsWith('/preferences')))
    {
     ...
     || path.startsWith('/owner-needed-documents')  || path.startsWith('/manage-payment') 
      || path.startsWith('/roles') || path.startsWith('/admins') || path.startsWith('/employee-franchise')
     || path.startsWith('/users') || path.startsWith('/users/deleted-user') || path.startsWith('/user/document')
     ...
     || path.startsWith('/driver-needed-documents')  || path.startsWith('/user-dashboard') || path.startsWith('/drivers-rating')
     ...
     || path.startsWith('/driver-bank-info') || path.startsWith('/driver-dashboard')
      || path.startsWith('/subscription') || path.startsWith('/user-needed-documents')

  ...
  <BContainer fluid>
    ...
    <template v-if="layoutType === 'vertical' || layoutType === 'semibox'">
      <ul class="navbar-nav h-100" id="navbar-nav">
        <div  v-if = "activeMenu === 'Home'" class="menu">
          ...
          <li class="nav-item" v-if="permissions.includes('promotion-management')">
            ...
            <div class="menu-dropdown collapse" id="promo">
              ...
              <li class="nav-item" v-if="permissions.includes('banner_image')">
                <Link class="nav-link" href="/bannerimage" data-key="t-banner-image">
                 {{ $t("app-module-banner-image") }}
                </Link>
              </li>
        ...
        <li class="menu-title"  v-if="permissions.includes('report-management')">
          <span data-key="t-other">{{ $t("report") }}</span>
        </li>
      ...
      <div  v-if = "activeMenu === 'Users'" class="menu">
        ...
        <li class="nav-item" v-if="permissions.includes('user-management')">
          <a class="nav-link menu-link" href="#customer" data-bs-toggle="collapse" role="button"
            aria-expanded="false" aria-controls="customer" :class="{ 'active': $page.url.startsWith('/user/document') }">
          ...
          <div class="collapse menu-dropdown" id="customer">
            <ul class="nav nav-sm flex-column">
              ...
              <li class="nav-item" v-if="permissions.includes('view-users')">
                <Link href="/users" class="nav-link" data-key="t-user-list" :class="{ 'active': $page.url.startsWith('/user/document') }">
                  {{ $t("user-list") }}
                </Link>
              </li>
              <li class="nav-item" v-if="permissions.includes('manage-user-needed-document')">
                <Link href="/user-needed-documents" class="nav-link" data-key="t-user-needed-documents">
                  {{ $t("user_needed_documents") }}
                </Link>
              </li> 
        ...
        <li class="nav-item" v-if="permissions.includes('manage-third-party-settings')">
          ...
          <div class="collapse menu-dropdown" id="thirdpartysetting">
            <ul class="nav nav-sm flex-column">
              ...
              <li class="nav-item" v-if="permissions.includes('osm-map-setting')">
                <Link href="/osm-map-setting" class="nav-link" data-key="t-osm-map-settings">
                  {{ $t("osm-map-settings") || 'OSM Map Settings' }}
                </Link>
              </li>
              <li class="nav-item" v-if="permissions.includes('map-show-setting')">
                <Link href="/map-show" class="nav-link" data-key="t-map-show">
                  {{ $t("map_show") }}
                </Link>
              </li>
              <!-- <li class="nav-item">
              ...
              <li class="nav-item" v-if="permissions.includes('notification-channel-view')">
                <Link href="/ai-setup" class="nav-link" data-key="t-notification-channel">
                  {{ $t("ai-setup") }}
                </Link>
              </li>
              <li class="nav-item" v-if="permissions.includes('social-auth-settings')">
                <Link href="/social-auth-settings" class="nav-link" data-key="t-social-auth-settings">
                  {{ $t("social-auth-settings") || "Social Auth Settings" }}
                </Link>
              </li>
            </ul>
          </div>

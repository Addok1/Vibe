                            ...
                            <div class="navbar-nav nav">
                                <ul class="navbar-nav">
                                  ...
                                  <li class="nav-item dropdown">
                                    ...
                                    <li class="nav-item dropdown">
                                        <Link class="nav-link nav-menu" href="/dispatcher/delivery-rides-request" role="button" v-if="permissions.includes('dispatcher-delivery-request')"
                                            :class="{ 'active': $page.url == '/dispatcher/delivery-rides-request' }">
                                                <i class="ri-taxi-fill"></i>
                                                <span class="ms-2">{{ $t("delivery-requests") }}</span>
                                        </Link>
                                    </li>

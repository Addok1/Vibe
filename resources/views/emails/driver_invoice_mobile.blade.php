  ...
  <body>
    ...
    <div class="page">
      ...
      <div class="invoice">
        ...
        <div class="thanks">
          {{custom_invoice_trans('for', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}} {{ $data['data'][0]['userDetail']['data']['name'] }}
        </div>
        ...
        <div class="body">
          ...
          <!-- LEFT -->
          <div class="col left">
            <div class="title">{{custom_invoice_trans('Trip Details', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}</div>
            <div class="divider"></div>
            <div class="row icon">
            ...
            <div class="row icon">
              ...
              {{custom_invoice_trans('kms', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}
              @else
              {{custom_invoice_trans('miles', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}
              @endif:
              {{ number_format($data['data'][0]['total_distance'], 2) }}
              @if ($data['data'][0]['unit'] == 'KM')
              <span>{{custom_invoice_trans('km', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}</span>
              @else
              <span>{{custom_invoice_trans('miles', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}</span>
              @endif
            </div>
            <div class="divider"></div>
            <div class="row icon">
          ...
          <div class="col right" style="margin-left:20px;padding-left:20px">
            ...
            <div class="title">{{custom_invoice_trans('bill_details', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}</div>
             <div class="divider"></div>
            
            <!-- base or bide fare -->
            <div class="bill">
                <span>{{custom_invoice_trans('Total Distance Driven', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}
                </span>
            ...
            <!-- distance fare -->
            <div class="bill">
              <span>{{custom_invoice_trans('distance_fare_for', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}} <br> 
                {{ number_format($data['data'][0]['total_distance'], 2) }}
                @if ($data['data'][0]['unit'] == 'KM')
                <span>{{custom_invoice_trans('km', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}</span>
                @else
             ...
             <!-- additional charges -->
              ...
              <div class="bill">
                <span>{{custom_invoice_trans('additional_charges', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}} <br> {{$data['data'][0]['requestBill']['data']['additional_charges_reason']}}</span>
            ...
            <div class="bill">
              ...
              <span>{{custom_invoice_trans('airport_surge_fee', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}</span>
              <span style="float:right;">{{ $data['data'][0]['requested_currency_symbol'] }}
            ...
            <!-- cancellation fee -->
            <div class="bill">
              <span>{{custom_invoice_trans('cancellation_fee', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}</span>
              <span style="float:right;">{{ $data['data'][0]['requested_currency_symbol'] }} {{ $data['data'][0]['requestBill']['data']['cancellation_fee'] }}</span>
            </div>
            <!-- convenience fee -->
            <div class="bill">
              <span>{{custom_invoice_trans('Thanks for driving with us', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}{{custom_invoice_trans('Customer Convenience Fee', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}</span>
              <span style="float:right;">- {{ $data['data'][0]['requested_currency_symbol'] }}
                    {{ number_format($data['data'][0]['requestBill']['data']['admin_commision'], 2) }}</span>
            </div>
            <!-- convenience fee -->
            <div class="bill highlight">
              <span>{{custom_invoice_trans('Trip Earnings', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}} ({{custom_invoice_trans('round_off', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}})</span>
              <span style="float:right;">{{ $data['data'][0]['requested_currency_symbol'] }}
        ...
        <!-- PAYMENT -->
        <div class="payment">
          <span>{{custom_invoice_trans('paid_by', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}</span>

...
@else
    <p>{{custom_invoice_trans('No logo available', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}</p>
@endif
<!-- <img width="76"
...
{{custom_invoice_trans('Thanks for driving with us', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}, {{  $data['data']['driverDetail']['data']['name'] }}
</td>
</tr>
<tr>
<td bgcolor="#ffffff" align="center"
...
">
{{custom_invoice_trans('Trip Details', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}
</td>
</tr>
<tr>
...
{{custom_invoice_trans('for', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}:
...
{{custom_invoice_trans('total', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}
{{ number_format($data['data']['total_distance'], 2) }}
@if ($data['data']['unit'] == 'KM')
{{custom_invoice_trans('km', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}
@else
{{custom_invoice_trans('miles', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}
@endif:
{{ number_format($data['data']['total_distance'], 2) }}
@if ($data['data']['unit'] == 'KM')
<div>{{custom_invoice_trans('km', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}</div>
@else
<div>{{custom_invoice_trans('miles', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}</div>
@endif
</td>
</tr>
</tbody>
...
{{custom_invoice_trans('total_mins', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}:
{{ number_format($data['data']['total_time'], 2) }}
{{custom_invoice_trans('min', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}:
...
border-bottom: 1px solid #d7d7d7;
">
{{custom_invoice_trans('bill_details', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}:
</td>
</tr>
<tr>
<td bgcolor="#ffffff">
...
{{custom_invoice_trans('Total Distance Driven', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}:
...
@if ($data['data']['unit'] == 'KM')
<div>{{custom_invoice_trans('km', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}:
</div>
@else
<div>{{custom_invoice_trans('miles', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}:
</div>
@endif
</td>
</tr>
...
font-weight: normal;
line-height: 18px;
"> {{custom_invoice_trans('additional_chargers', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}:
...
line-height: 18px;
">
{{custom_invoice_trans('airport_surge_fee', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}:
</td>
</tr>
</tbody>
</table>
...
line-height: 18px;
">
{{custom_invoice_trans('cancellation_fee', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}:
</td>
</tr>
</tbody>
</table>
...
line-height: 18px;
">
{{custom_invoice_trans('Customer Convenience Fee', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}:
...
line-height: 18px;
">
{{custom_invoice_trans('Trip Earnings', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}:


<span
style="font-family: Helvetica, 'Helvetica Neue', Arial, sans-serif; color: #707070; font-size: 13px; font-weight: normal">({{custom_invoice_trans('rounded_off', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}:
)</span>
</td>
</tr>
</tbody>
...
">
{{custom_invoice_trans('Payment', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}:
...
@endphp
@endif
{{custom_invoice_trans('paid_by', [] ,$data['data']['driverDetail']['data']['lang'] ?? 'en')}}:
{{ $payment }}
</td>
</tr>
</tbody>

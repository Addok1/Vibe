    ...
    { 
        ...
        $notification =[
                ...
                [
                    'id' => Str::uuid(),
                    'role' =>'user',
                    'topics' => 'User Account Approval',
                    'topics_content' => 'Choose how User will get notified about Sent notification on account approval',
                    'push_notification' => 1,
                    'mail' => 1,
                    'sms' => 1,
                    ...
                    'mail_body' => '
                                    ...
                                    <p>We are happy to inform you that your user account has been successfully approved. Start exploring the app and enjoy a seamless experience...</p>   
                ...
                [
                    'id' => Str::uuid(),
                    'role' =>'user',
                    'topics' => 'User Account Disapproval',
                    'topics_content' => 'Choose how User will get notified about Sent notification on account disapproval',
                    'push_notification' => 1,
                    'mail' => 1,
                    'sms' => 1,
                    ...
                    'mail_body' => '
                                    <p>Hello {name}</p>
                                    <p> We regret to inform you that your application to become a user with our taxi service has not been approved at this time.</p>   
                        ...
                        'fr' => [
                            ...
                            'User Account Approval' => [
                                ...
                                'mail_body' => '<p>Félicitations, {name}</p>
                                                <p>Nous sommes heureux de vous informer que votre compte utilisateur a été approuvé avec succès. Commencez à explorer l’application et profitez d’une expérience fluide..</p>
                            ...
                            'User Account Disapproval' => [
                                'email_subject' => "Refus du compte",
                                'mail_body' => '<p>Bonjour, {name}</p>
                                                <p>Nous avons le regret de vous informer que votre demande pour devenir utilisateur auprès de notre service de taxi n\'a pas été approuvée pour le moment.</p>
                        ...
                        'es' => [
                            ...
                            'User Account Approval' => [
                                ...
                                'mail_body' => '<p>Felicidades, {name}</p>
                                                <p>Nos complace informarle que su cuenta de usuario ha sido aprobada con éxito. Comience a explorar la aplicación y disfrute de una experiencia fluida...</p>
                            ...
                            'User Account Disapproval' => [
                                ...
                                'mail_body' => '<p>Hola, {name}</p>
                                                <p>Lamentamos informarle que su solicitud para convertirse en usuario de nuestro servicio de taxis no ha sido aprobada en este momento.</p>
                        ...
                        'ar' => [
                            ...
                            'User Account Approval' => [
                                ...
                                'mail_body' => '<p>تهنئة, {name}</p>
                                                <p>يسعدنا إعلامكم بأنه قد تمت الموافقة على حساب المستخدم الخاص بكم بنجاح. ابدأوا استكشاف التطبيق واستمتعوا بتجربة سلسة...</p>
                            ...
                            'User Account Disapproval' => [
                                ...
                                'mail_body' => '<p>مرحبًا {name}</p>
                                                <p> يؤسفنا إبلاغكم بأن طلبكم للانضمام كمستخدم لخدمة سيارات الأجرة لدينا لم تتم الموافقة عليه في الوقت الحالي.</p>

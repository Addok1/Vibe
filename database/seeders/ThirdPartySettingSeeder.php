...
class ThirdPartySettingSeeder extends Seeder
{
    ...
    protected $payment_settings = [
        ...
        ['name' => 'mapbox_public_key',
            'value' => 'Your Public Key',
            'module' => 'map',
        ],
        ['name' => 'enable_thunderforest',
            'value' => '0',
            'module' => 'map',
        ],
...
//firebase setting
        ...
        ['name' => 'enable_firebase_otp_control',
            'value' => '1',
            'module' => 'sms',
        ],
        //twilio       
        ...
        ['name' => 'pawapay_environment',
            'value' => 'test',
            'module' => 'payment',
        ],
        ['name' => 'pawapay_test_base_url',
            'value' => 'https://api.sandbox.pawapay.io',
            'module' => 'payment',
        ],
        ['name' => 'pawapay_live_base_url',
            'value' => 'https://api.pawapay.io',
            'module' => 'payment',
        ],
        ['name' => 'pawapay_test_api_key',
            'value' => 'Enter Pawapay Test API Key',
            'module' => 'payment',
        ],
        ['name' => 'pawapay_live_api_key',
            'value' => 'Enter Pawapay Live API Key',
            'module' => 'payment',
        ],
        ['name' => 'pawapay_correspondent',
            'value' => '',
            'module' => 'payment',
        ],
        ['name' => 'pawapay_webhook_secret',
         ...
         ['name' => 'open_ai_organization_name',
            'value' => 'your-open-ai-organization_name',
            'module' => 'ai-setup',
        ],
        ['name' => 'enable_open_ai_setup',
            'value' => '0',
            'module' => 'ai-setup',
        ],

        // social auth (web booking + mobile api)
        ...
        ['name' => 'enable_apple_social_login',
            'value' => '0',
            'module' => 'social-auth',
        ],

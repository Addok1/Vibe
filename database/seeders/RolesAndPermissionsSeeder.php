...
//   thirdparty settings
        ...
        PermissionSlug::OPEN_AI_SETUP => [
            'name' => 'open-ai-setup',
            'description' => 'open-ai-setup',
            'main_menu'=>'third-party-settings',
            'sub_menu'=>null,
            'main_link'=>'open-ai-setup',
        ],
        PermissionSlug::SOCIAL_AUTH_SETTINGS => [
            'name' => 'social-auth-settings',
            'description' => 'social-auth-settings',
            'main_menu'=>'third-party-settings',
            'sub_menu'=>null,
            'main_link'=>'social-auth-settings',
        ],
        ...
        PermissionSlug::MAP_SHOW_SETTING => [
            'name' => 'map-show-setting',
            'description' => 'map show settings view lists',
            'main_menu'=>'third-party-settings',
            'sub_menu'=>null,
            'main_link'=>'map-show-setting',
        ],
        PermissionSlug::OSM_MAP_SETTING => [
            'name' => 'osm-map-setting',
            'description' => 'osm map show settings',
            'main_menu'=>'third-party-settings',
            'sub_menu'=>null,
            'main_link'=>'osm-map-setting',
        ],
...
/* roleS */
        ...
        PermissionSlug::DISPATHCER_ONGOING_REQUEST_ASSIGN => [
         ...
         PermissionSlug::DISPATCHER_DELIVERY_REQUEST_VIEW => [
            'name' => 'dispatcher-delivery-request',
            'description' => 'delivery request view lists',
            'main_menu'=>'delivery-request',
            'sub_menu'=>null,
            'main_link'=>'delivery-request-view',
        ], 
...
/* Airport */       
        ...
        PermissionSlug::AGENT_DELIVERY_REQUEST_VIEW => [
            'name' => 'agent-delivery-request',
            'description' => 'delivery request view lists',
            'main_menu'=>'delivery-request',
            'sub_menu'=>null,
            'main_link'=>'delivery-request-view',
...
// Manage franchise Owner Needed Doc
        ...
        PermissionSlug::SINGLE_DELETE_HEADER_FOOTER => [
         ...
         PermissionSlug::USER_APPROVAL => [
            'name' => 'user-approval',
            'description' => 'users approval',
            'main_menu'=>'user-management',
            'sub_menu'=>null,
            'main_link'=>'user-approval',
        ],
        PermissionSlug::USER_DISAPPROVAL => [
            'name' => 'user-disapproval',
            'description' => 'users disapproval',
            'main_menu'=>'user-management',
            'sub_menu'=>null,
            'main_link'=>'user-disapproval',
        ],
        PermissionSlug::USER_UPLOAD_DOCUMENTS => [
            'name' => 'user-upload-documents',
            'description' => 'users documents upload',
            'main_menu'=>'user-management',
            'sub_menu'=>null,
            'main_link'=>'user-upload-documents',
        ],
        // Manage Driver Needed Doc
        PermissionSlug::MANAGE_USER_NEEDED_DOC => [
            'name' => 'manage-user-needed-document',
            'description' => 'List user needed documents',
            'main_menu'=>'user-management',
            'sub_menu'=>null,
            'sub_link'=>'manage-user-needed-document',
        ],     
        PermissionSlug::ADD_USER_NEEEDED_DOC => [
            'name' => 'add-user-needed-document',
            'description' => 'Add user needed documents',
            'main_menu'=>'user-management',
            'sub_menu'=>null,
            'sub_link'=>'add-user-needed-document',
        ],         
        PermissionSlug::EDIT_USER_NEEEDED_DOC => [
            'name' => 'edit-user-needed-document',
            'description' => 'Edit user needed documents',
            'main_menu'=>'user-management',
            'sub_menu'=>null,
            'sub_link'=>'edit-user-needed-document',
        ],         
        PermissionSlug::DELETE_USER_NEEEDED_DOC => [
            'name' => 'delete-user-needed-document',
            'description' => 'Delete user needed documents',
            'main_menu'=>'user-management',
            'sub_menu'=>null,
            'sub_link'=>'delete-user-needed-document',
        ], 
        PermissionSlug::TOGGLE_USER_NEEEDED_DOC => [
            'name' => 'toggle-user-needed-document',
            'description' => 'toggle-user-needed-document',
            'main_menu'=>'user-management',
            'sub_menu'=>null,
            'sub_link'=>'toggle-user-needed-document',
        ], 
        PermissionSlug::VIEW_USER_DOCUMENT => [
            'name' => 'view-user-document',
            'description' => 'View User Document',
            'main_menu' => 'user-management',
            'sub_menu' => 'manage-users',
            'main_link' => 'view-user-document',
        ],

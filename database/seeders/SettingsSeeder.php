...
class SettingsSeeder extends Seeder
{
    ...
    protected $settings_from_seeder = [
        ...
        SettingSlug::ENABLE_MAP_SHOW_HOME_SCREEN => [
            'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
...
// Driver Referral Settings //
        ...
        SettingSlug::ENABLE_DRIVER_SIGN_UP_FEATURE => [
         ...
         SettingSlug::SHOW_WALLET_ADD_MONEY_FEAUTRE_ON_MOBILE_APP => [
            'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
         ...
         SettingSlug::SHOW_WALLET_ADD_MONEY_FEAUTRE_ON_MOBILE_APP_FOR_DRIVER => [
            'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::SHOW_WALLET_ADD_MONEY_FEAUTRE_ON_MOBILE_APP_FOR_OWNER => [
            'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::BANNER_TITLE_COLOR => [
            'category'=>SettingCategory::GENERAL,
            'value' => '#ffff',
            'field' => SettingValueType::TEXT,
            'option_value' => null,
        ...
        SettingSlug::BANNER_DESCRIPTION_COLOR => [
            'category'=>SettingCategory::GENERAL,
            'value' => '#ffff',
            'field' => SettingValueType::TEXT,
            'option_value' => null,
        ...
        SettingSlug::BANNER_BUTTON_COLOR => [
            'category'=>SettingCategory::GENERAL,
            'value' => '#ffff',
            'field' => SettingValueType::TEXT,
            'option_value' => null,
        ...
        SettingSlug::ENABLE_USER_DOCUMENT_UPLOAD => [
            'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::ENABLE_INVOICE_DOWNLOAD => [
            'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
